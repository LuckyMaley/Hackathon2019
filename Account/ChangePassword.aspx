<%@ Page Title="Change Password" Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ChangePassword.aspx.vb" Inherits="Hackathon2019.Account.ChangePassword" %>
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                    <asp:Button ID="CancelPushButton" runat="server" CausesValidation="False" 
                        CommandName="Cancel" Text="Cancel" CssClass="btn" Height="44px"/>
                    &nbsp;<asp:Button ID="ChangePasswordPushButton" runat="server" 
                        CommandName="ChangePassword" Text="Change Password" 
                         ValidationGroup="ChangeUserPasswordValidationGroup" 
                        onclick="ChangePasswordPushButton_Click" CssClass="btn" Height="43px"/>
                </p>
            </div>
        </ChangePasswordTemplate>
    </asp:ChangePassword>
